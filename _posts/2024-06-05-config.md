...
➤ Debemos introducir el usuario y contraseña que hemos creado. En mi caso el usuario es meghribe y la contraseña 42Password-.
...
1. Para la instalación de sudo primero debemos estar en el usuario **root**, para ello pondremos `su` en el terminal e introduciremos la contraseña, en mi caso es `42Barcelona-`.
```bash
su
```
